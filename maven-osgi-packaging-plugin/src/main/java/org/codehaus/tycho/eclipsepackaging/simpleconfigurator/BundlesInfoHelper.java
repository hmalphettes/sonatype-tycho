...
public class BundlesInfoHelper {
	...
	public static void writeBundlesInfo(Map<String, BundleConfiguration> bundlesToStart,
	...
	throws MojoExecutionException, MojoFailureException
	{
		...
		try {
			...
			{
				writer.write(createBundleInfoLine(pd, bundlesToStart.get(pd.getKey().getId())));
				writer.newLine();
			}
		}
		catch (IOException e)
	...
	public static String createBundleInfoLine(PluginDescription bundleInfo, BundleConfiguration bundleConfig) {
		...
		buffer.append(',');
		buffer.append(createBundleLocation(bundleInfo.getLocation().toURI()));
		buffer.append(',');
